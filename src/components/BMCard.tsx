    ...
    >
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          {available && bm.valor && (
            <span className="inline-flex items-baseline gap-0.5 rounded-lg bg-emerald-500/10 px-3 py-1.5 font-bold text-emerald-400 ring-1 ring-emerald-500/25">
      ...
      {available && (
        <a
          href={`${WHATSAPP_URL}?text=${encodeURIComponent(`Vim pelo site e tenho interesse na ${bm.name}`)}`}
          target="_blank"
